...
md`
This notebook contains an extendable radar chart. Browse the code below to see configurable options and re-use the radar chart cell in any notebook using the following command: 
\`\`\`js
